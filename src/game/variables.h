...
MACRO_CONFIG_INT(InfHeroAuraKills, inf_heroaurakills, 8, 0, 0, CFGFLAG_SERVER, "Kills needed for heroaura.")
...
MACRO_CONFIG_STR(InfHeroAuraText, inf_airstrike_text, 512, "Hero %s have a heroaura!", CFGFLAG_SERVER, "Text send when someone earns a heroaura (%s = player name)")
